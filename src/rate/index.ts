...
import {
  InfoRepository, Rate, RateFilter, RateId, rateModel, RateReaction,
  rateReactionModel, RateReactionRepository, RateRepository, RateService, Reply, ReplyFilter,
  ReplyId, replyModel, ReplyRepository, ReplyService
} from './rate';
